...
import fetchLookupData from '@salesforce/apex/InvoiceProfileLookup.fetchLookupData';
...
export default class CustomLookupLwc extends LightningElement {
  ...
  /*  connectedCallback(){
    ...
    @wire(fetchLookupData, { searchKey: '$searchKey' , sObjectApiName : '$sObjectApiName' , contactId:'$defaultRecordId'})
     searchResult(value) {
