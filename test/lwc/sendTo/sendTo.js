...
export default class EmailInput extends LightningElement {
    ...
    handleInputChange(event) {
        ...
        search({ searchKeyWord: event.target.value, excludedlist: this.selectedValues })
            .then((result) => {
                this.items = result;
                console.log('search method items==='+this.items);
    ...
    get hasItems() {
        console.log('hasItems length==='+this.items.length);
    ...
    onSelect(event) {
        ...
        this.selectedValuesMap.set(selectedValue.Match_Maker__Email__c, selectedValue.Name);
        console.log('this.selectedValuesMap=='+this.selectedValuesMap);
        this.selectedValues = [...this.selectedValuesMap.keys()];
        console.log('this.selectedValuesMap and this.selectedValues=='+this.selectedValues);
